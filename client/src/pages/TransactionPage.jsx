    ...
    return (
        <div className="h-screen max-w-4xl mx-auto flex flex-col items-center">
          ...
          from-pink-500 to-pink-500 hover:from-pink-600 hover:to-pink-600"
            ...
            <a
                href="/"
                className="bg-transparent hover:bg-[#F6009B] text-[#F6009B] hover:text-white rounded shadow hover:shadow-lg py-2 px-4 mt-7 border border-[#F6009B] hover:border-transparent"
            >
                Take me home
            </a>
        </div>
